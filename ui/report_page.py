...
def render_report(engine):
    ...
    for section, kind, symbol, headline, body, p in deferred:
        if section == "masthead":
            ...
            parts.append('<div class="mr-foot">USD 100 goes into a stock EVERY day its '
                         'last two readings are Strong Buy, and everything comes out at '
                         'the close after two straight readings below Buy — each lot an '
                         'independent bet, mirrored to the cent by USD 100 into the '
                         'S&amp;P 500 on identical days. Sold lots stay on the record.</div>')
    parts.append("</div>")
