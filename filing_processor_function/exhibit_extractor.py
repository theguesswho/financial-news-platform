# exhibit_extractor.py (Manual Parsing Version)
...
if __name__ == "__main__":
    # We will use the 8-K filing that we know has an acquisition press release
    sample_8k_url = "https://www.sec.gov/Archives/edgar/data/320193/000119312524061695/d649493d8k.htm"
    extract_press_release(sample_8k_url)